...
## Lista de libros
Ésta es una lista más pequeña de la que yo usé. Esta abreviado para ahorrarte tiempo.

### Preparación para la entrevista

- [ ] [Programming Interviews Exposed: Secrets to Landing Your Next Job, 2nd Edition](http://www.wiley.com/WileyCDA/WileyTitle/productCd-047012167X.html)
    - respuestas en C++ y Java
    - recomendado en coaching de candidatos Google
    - este es un buen calentamiento para Cracking the Coding Interview
    - no está muy difícil, la mayoría de los problemas podrán ser más fáciles de los que verás en la entrevista (dentro de lo que e leído)
- [ ] [Cracking the Coding Interview, 6th Edition](http://www.amazon.com/Cracking-Coding-Interview-6th-Programming/dp/0984782850/)
    - respuestas en Java
    - recomendado en el [Sitio de Carreras Google](https://www.google.com/about/careers/how-we-hire/interview/)
    - si ves personas hacer referiencia a el "Currículum Google", es un libro reemplazado por "Cracking the Coding Interview".

Si tienes mucho tiempo libre:

- [ ] [Elements of Programming Interviews](https://www.amazon.com/Elements-Programming-Interviews-Insiders-Guide/dp/1479274836)
    - todo el código es en C++, muy bueno si planeas usar C++ en la entrevista.
    - un buen libro para resolver problemas en general.
    
### Architectura Computacional

Si no tienes mucho tiempo:

- [ ] [Write Great Code: Volume 1: Understanding the Machine](https://www.amazon.com/Write-Great-Code-Understanding-Machine/dp/1593270038)
    - El libro fue publicado en el 2004, y está un poco anticuado, pero es un exelente recurso para entender una computadora brevemente.
    - El autor invento HLA, asi que toma menciones y ejemplos de HLA con un grano de sal. No es usado mucho, pero decentes ejemplos de como se ve assembly.
    - Estos capítulos valen la pena leer para darte una fundación:
...
Si tienes más tiempo (yo quiero éste libro):

- [ ] [Computer Architecture, Fifth Edition: A Quantitative Approach](https://www.amazon.com/dp/012383872X/)
    - Para un abundante, mas a la fecha (2011), pero más largo tratamiento
    
### 

** Necesitas escoger un lenguaje para la entrevista (vea arriba).** Estas son mis recomendaciones por lenguaje. No tengo los recursos para todos los lenguajes. Addiciones son bienvenidas.

Si leiste algunos de estos, deberías tener todo el conocimiento de estructura de datos y algoritmos que necesitas para empezae a hacer problemas de còdigo.
**Puedes brincar todos los videos de conferencia en éste projecto**, al menos que te gustaría repasar.

[Recursos específicos al lenguaje aquí.](programming-language-resources.md)

### C++

No e leído estos dos, pero son altamente clasificados y escritos por Sedgewick. Es genial.

- [ ] [Algorithms in C++, Parts 1-4: Fundamentals, Data Structure, Sorting, Searching](https://www.amazon.com/Algorithms-Parts-1-4-Fundamentals-Structure/dp/0201350882/) 
- [ ] [Algorithms in C++ Part 5: Graph Algorithms](https://www.amazon.com/Algorithms-Part-Graph-3rd-Pt-5/dp/0201361183/)

Si tienes una mejor recomendación para C++, por favor déjame saber. Estoy buscando a un recurso comprensivo.

### Java

- [ ] [Algorithms (Sedgewick and Wayne)](https://www.amazon.com/Algorithms-4th-Robert-Sedgewick/dp/032157351X/)
    - videos con el contenido del libro (y Sedgewick!):
...
- [ ] [Data Structures and Algorithms in Java](https://www.amazon.com/Data-Structures-Algorithms-Michael-Goodrich/dp/1118771338/)
 ...
    - usado como texto opcional para el curso de introducción de Ciencias de Computación en UC Berkeley
    - ve mi reporte de la version de Python abajo. Éste libro cubre los mismos temas.

### Python

- [ ] [Data Structures and Algorithms in Python](https://www.amazon.com/Structures-Algorithms-Python-Michael-Goodrich/dp/1118290275/)
    - por Goodrich, Tamassia, Goldwasser
    - Yo amo éste libro. Cubrió todo y más.
    - Código Python
    - mi reporte del libro: https://googleyasheck.com/book-report-data-structures-and-algorithms-in-python/


### Libros opcionales

**Algunas personas me recomiendan estos, pero creo que ya es pasarse, a menos que tengas muchos años de experencia de Ingenieria de Computación y esperas una entrevista mucho mas difícil:**

- [ ] [Algorithm Design Manual](http://www.amazon.com/Algorithm-Design-Manual-Steven-Skiena/dp/1849967202) (Skiena)
    - Como un repaso y recognición de problemas
    - La porción de catálogo de algoritmos es muy arriba del alcance de la dificultad que tendrás en una entrevista
    - Éste libro contiene 2 parted:
        - libro de texto en estructura de datos y algoritmos
            - lo bueno:
                - es un buen repaso así como cualquier libro de algoritmos podría ser
                - lindas historias de sus experiences resolviendo problemas en la industria y en la academia
                - muestras de código en C
            - lo malo:
